...
from services.openai_service import (
    ...
    generate_arthritis_chatbot_response
)
...
@routes.route("/api/arthritis-chat", methods=["POST"])
@cross_origin()
def arthritis_chatbot_endpoint():
    """General AI chatbot for arthritis queries."""
    data = request.json
    message = data.get("message")
    ...
    response = generate_arthritis_chatbot_response(message)
    return jsonify(response)
